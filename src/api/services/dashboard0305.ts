...
export const fetchTodaysDataSyncDailyLoadAll = async () => {
	...
	let allSum = 0;
	let _newArr = [];
	// console.log("3p -> ",result)
	// console.log("1p -> ",res1p.data.data)

	result.map(function (key, value) {
		// console.log("Data ",res3p.data.data[value].countDistinct.meter_serial_number)
...
export const fetchTodaysDataSyncBlockLoadAll = async () => {
	...
	let allSum = 0;
	let _newArr = [];
	// console.log("data 3p : ",result)
	// console.log("data 1p : ",res1p.data.data)
	...
	// const chartDataHourly = _newArr?.filter(
	// 	(item) =>
...
export const fetchTodaysDataSyncInstantAll = async () => {
	...
	let allSum = 0;
	let _newArr = [];
	console.log("data HES 3p : ",res3p)
	// console.log("data HES 1p : ",res1p)
...
export const fetchTodaysDataSyncInstantSinglePhase = async () => 	{
	...
	console.log("Instantaneous Chart Data -> ", res)
...
console.log(p1hr);
	...
	//console.log("unique data", arrlen)
	//let arrtotal = arrlen.map((item, index) => item + arrmin0to14[index])
...
export const fetchPowerConsumptionOf30DaysAll = async () => {
	...
	// console.log("Last 30 Days 1p :- ",res1p?.data?.data)
