...
import {fetchPowerConsumptionOfADayThird} from 'api/services/dashboard'
...
const DayWiseConsumptionThirdPhase = () => {
	
	const [date, setDate] = useState(format(new Date(), 'yyyy-MM-dd'))
	
	const {data, isLoading, error, mutate} = useMutation(
		'powerConsumptionOfADayThird',
		fetchPowerConsumptionOfADayThird
	)
...
export default DayWiseConsumptionThirdPhase
