...
import { fetchPowerConsumptionInMonthThird, fetchLatestTimeForPowerConsumptionMonthlyAndYearlySingle } from 'api/services/dashboard'
...
const MonthlyThird = () => {
	...
	const { data, error, isLoading, mutate } = useMutation(
		'monthlyPowerConsumptionThird', fetchPowerConsumptionInMonthThird
	)
		...
		<Card mb={6}>
			...
			{!isLoading ? (
				<Chart
					...
					type='line'
					options={{
						chart: { id: 'monthly-consumption-third' },
						xaxis: {
							categories: arr,
							title: { text: 'Month' },
							labels: {
