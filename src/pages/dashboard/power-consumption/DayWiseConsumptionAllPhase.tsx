...
import {fetchPowerConsumptionOfADayAll} from 'api/services/dashboard'
...
const DayWiseConsumptionAllPhase = () => {
	
	const [date, setDate] = useState(format(new Date(), 'yyyy-MM-dd'))
	
	const {data, isLoading, error, mutate} = useMutation(
		'fetchPowerConsumptionOfADayAll',
		fetchPowerConsumptionOfADayAll
	)
...
export default DayWiseConsumptionAllPhase
