...
import {
	...
	fetchPowerConsumptionByYearThird,
...
const DoughnutChartThird = ({ theme }) => {
	...
	const {
		...
		isLoading,
		mutate,
	} = useMutation('powerConsumptionTillEndOfYear', fetchPowerConsumptionByYearThird)
	...
	// console.log("Total Usage DoughnutChart", newsum)
	...
	// console.log("doughnutData ",donutdata)
...
export default withTheme(DoughnutChartThird);
