...
import {
	...
	fetchPowerConsumptionByYearAll,
...
const DoughnutChartAll = ({ theme }) => {
	...
	const {
		...
		isLoading,
		mutate,
	} = useMutation('fetchPowerConsumptionByYearAll', fetchPowerConsumptionByYearAll)
	...
	return (
		<Card mb={8}>
			...
			<CardContent>
				<ChartWrapper>
					<DoughnutInner>
						<Typography variant="h6" sx={{fontSize:"14px !important"}}>TOTAL CONSUMPTION</Typography>
...
export default withTheme(DoughnutChartAll);
