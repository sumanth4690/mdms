...
const Percentage = styled(MuiTypography)`
  span {
    color: ${(props: { percentagecolor: any; }) => props.percentagecolor};
    font-weight: 600;
    ...
    <Card illustration={illustration}>
      <CardContent>
        ...
        >
          ...
          <div className="prepaidtimeclass"><AccessAlarmIcon className="alarmicon" />{statstime}</div>
        </Percentage>
