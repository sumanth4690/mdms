...
import {fetchTodaysDataSyncBlockLoadAll, fetchTodaysDataSyncBlockLoadSingle} from 'api/services/dashboard'
...
const DataSync2BlockLoadAll = () => {
	const {data, isLoading, error} = useQuery(
		'dataSyncInstantBlockLoadAll',
		fetchTodaysDataSyncBlockLoadAll
		// fetchTodaysDataSyncBlockLoadSingle
	)
	console.log("HES ", data);
...
export default DataSync2BlockLoadAll
